...
export const SERVICES: Service[] = [
        ...
        sections: [
            {
                ...
                heading: "Overcome Anxiety, PTSD, and Emotional Pain with Eye Movement Desensitization and Reprocessing (EMDR)",
                intro: [
                ...
                steps: [
                    {
                        ...
                        description: "We discuss your background and the goals you want to reach in therapy.",
                    },
                    {
                        title: "Preparation",
                        description: "You learn grounding techniques that keep you emotionally safe throughout the work.",
                    },
                    {
                        title: "Processing",
                        description: "Using guided eye movements, tapping, or audio tones, we reprocess distressing memories.",
                    },
                    {
                        title: "Integration",
                        description: "Relaxation techniques reinforce the positive changes and lock in new, adaptive beliefs.",
                    },
                ],
            },
            {
    ...
    },
    {
        ...
        tagline: "Strengthening bonds, healing together: family-centered care for eating disorders.",
        category: "Eating Disorders",
        image: "/productSummaryCards/family_based_therapy.jpg",
        imageAlt: "A family of four walking together, holding hands along a sidewalk",
        sections: [
            {
                kind: "hero",
                ...
                steps: [
                    {
                        ...
                        description: "Parents take charge of meals and nutrition while therapy addresses eating-related distress.",
                    },
                    {
                        title: "Gradual Return to Independence",
                        description: "As health stabilizes, responsibility around eating shifts back to the child.",
                    },
                    {
                        title: "Developing Healthy Autonomy",
                        description: "The individual regains independence while the family works to prevent relapse.",
                    },
                ],
            },
            {
    ...
    },
    {
        ...
        tagline: "Unlock new perspectives: ketamine-assisted therapy for depression, anxiety, and trauma.",
        category: "Psychedelic-Assisted",
        image: "/productSummaryCards/kap.png",
        imageAlt: "A person resting with an eye mask and headphones during a ketamine dosing session",
        sections: [
            {
                kind: "hero",
                eyebrow: "Psychedelic-Assisted",
                ...
                steps: [
                    {
                        ...
                        description: "The medical team reviews your history, provides education, determines eligibility, and develops a personalized prescription and monitoring plan.",
                    },
                    {
                        title: "Preparation Sessions",
                        description: "We align on the process and set intentions before your first dosing session.",
                    },
                    {
                        title: "KAP Dosing Session",
                        description: "Lasting 1–2 hours via telehealth, you record vitals and self-administer a ketamine lozenge while reclining with an eye mask and calming music. Your therapist stays present, with an on-site chaperone for added support.",
                    },
                    {
                        title: "Integration Sessions",
                        description: "Follow-up therapy sessions help you review insights and prepare for subsequent journeys.",
                    },
                    {
                        title: "Follow-up Medical Consultations",
                        description: "Quarterly check-ins, at minimum, monitor outcomes and handle prescription refills.",
                    },
                ],
            },
            {
            ...
            {
                kind: "callout",
                body: "Ketamine is legal in all 50 states. All dosing takes place under medical supervision in a monitored clinical setting.",
            },
        ],
    },
    {
        slug: "group-kap",
        title: "Group KAP",
        tagline: "Collective healing: transformative journeys with group ketamine therapy.",
        category: "Psychedelic-Assisted",
        image: "/productSummaryCards/group_kap.jpg",
        imageAlt: "A group of people sitting together on the ground, laughing",
        sections: [
            {
                kind: "hero",
                eyebrow: "Psychedelic-Assisted",
                heading: "Group Ketamine-Assisted Psychotherapy",
                intro: [
                ...
                steps: [
                    {
                        ...
                        description: "A medical intake and psychological screening confirm that group work is right for you.",
                    },
                    {
                        title: "Guided Administration",
                        description: "Ketamine is administered in a controlled setting, held by trained therapists.",
                    },
                    {
                        title: "Integration Therapy",
                        description: "Group members engage in therapist-led discussions to reflect on insights, process emotions, and develop strategies.",
                    },
                ],
            },
            {
    ...
    },
    {
        ...
        tagline: "Precision care: tailored medication management for your mental wellness.",
        category: "Psychiatric Care",
        image: "/productSummaryCards/medication_management.jpg",
        imageAlt: "A clinician with a tablet in conversation with a client on a couch",
        sections: [
            {
                kind: "hero",
            ...
            },
            {
                ...
                steps: [
                    {
                        title: "Evaluation",
                        description: "Your provider reviews your symptoms and medical history in depth.",
                    },
                    {
                        title: "Prescribe & Adjust",
                        description: "Psychiatric medications are prescribed and fine-tuned as your needs change.",
                    },
                    {
                        title: "Monitor",
                        description: "Side effects and effectiveness are tracked closely over time.",
                    },
                    {
                        title: "Ongoing Support",
                        description: "Regular check-ins keep your treatment plan aligned with your goals.",
                    },
                ],
            },
            {
    ...
    },
    {
        slug: "mdma",
        title: "MDMA Therapy",
        tagline: "Discover connection: MDMA-assisted therapy for profound healing.",
        category: "Psychedelic-Assisted",
        image: "/assets/Untitled-design-15-890x664.png",
        imageAlt: "A woman sitting in thought, holding a small vial of medicine",
        sections: [
            {
                kind: "hero",
                eyebrow: "Psychedelic-Assisted",
            ...
            {
                kind: "callout",
                body: "The FDA declined commercial authorization in August 2024 and requested additional trials. MDMA-assisted therapy is not available until at least 90 days after FDA approval is achieved.",
            },
        ],
    },
    {
        ...
        tagline: "A groundbreaking avenue for treatment-resistant depression and growth.",
        category: "Psychedelic-Assisted",
        image: "/assets/m1000x1000.jpeg",
        imageAlt: "A person resting peacefully, surrounded by soft clouds",
        sections: [
            {
                kind: "hero",
                eyebrow: "Psychedelic-Assisted",
            ...
            {
                kind: "callout",
                body: "Psilocybin therapy is currently not approved by any regulatory agency in nearly all states and is only available through clinical trials.",
            },
        ],
    },
    {
        slug: "psychotherapy",
        title: "Psychotherapy",
        tagline: "Empower your mind: transformative psychotherapy for a balanced life.",
        category: "Talk Therapy",
        image: "/productSummaryCards/psychotherapy.jpg",
        imageAlt: "A woman smiling gently by a window in a bright room",
        sections: [
            {
                kind: "hero",
    ...
    },
    {
        ...
        tagline: "Revitalize connections: ketamine-assisted psychotherapy for couples and families.",
        category: "Psychedelic-Assisted",
        image: "/assets/Untitled-design-28-890x664.png",
        imageAlt: "Two people sitting side by side outdoors in open conversation",
        sections: [
            {
                kind: "hero",
                eyebrow: "Psychedelic-Assisted",
            ...
            },
            {
                ...
                steps: [
                    {
                        title: "Assessment",
                        description: "A medical intake and psychological assessment confirm fit; individual KAP sessions are recommended beforehand.",
                    },
                    {
                        title: "Guided Sessions",
                        description: "Structured, professionally guided experiences combine ketamine therapy with relationship counseling techniques.",
                    },
                    {
                        title: "Integration",
                        description: "Together you apply insights to couples dynamics, family patterns, and attachment wounds.",
                    },
                ],
            },
            {
    ...
    },
    {
        ...
        tagline: "Exploring Sensorimotor Psychotherapy for trauma healing through the body.",
        category: "Somatic & Trauma",
        image: "/productSummaryCards/sensorimotor_psychotherapy.jpg",
        imageAlt: "A woman seated with her eyes closed and hands raised beside her head",
        sections: [
            {
                kind: "hero",
                eyebrow: "Somatic & Trauma",
                heading: "Sensorimotor Psychotherapy: Healing Trauma Through the Mind-Body Connection",
                intro: [
                ...
                steps: [
                    {
                        ...
                        description: "You learn to observe and stay with body sensations from a place of safety.",
                    },
                    {
                        title: "Processing & Healing Trauma",
                        description: "Together we identify and gently release patterns stuck in the body.",
                    },
                    {
                        title: "Integration & Growth",
                        description: "You strengthen resilience and a renewed sense of empowerment.",
                    },
                ],
            },
            {
        ...
        sections: [
            {
                ...
                heading: "TRIP™ — Trauma Recovery Integration Pathway: Find Peace, Strength, and Freedom",
                intro: [
            ...
            },
            {
                ...
                steps: [
                    {
                        title: "EMDR Therapy",
                        description: "Reprocess distressing memories so they lose their emotional charge.",
                    },
                    {
                        title: "Somatic Therapy",
                        description: "Address trauma stored in the body, not just the mind.",
                    },
                    {
                        title: "Ketamine-Assisted Therapy",
                        description: "Support deep trauma healing where other approaches have stalled.",
                    },
                    {
                        title: "Mindfulness & Holistic Approaches",
                        description: "Use meditation and visualization to restore a sense of safety.",
                    },
                ],
            },
            {
        ...
        sections: [
            {
                ...
                heading: "GRIP™ — Group Recovery Integration Pathway: Ketamine-Assisted Retreats for Deep Healing and Connection",
                intro: [
            ...
            {
                kind: "callout",
                body: "GRIP™ retreats are coming soon to The Psyberspace Center for Psychedelic Therapy. Join our mailing list to hear when dates are announced.",
            },
        ],
    },
]
